        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-2xl font-black text-slate-900 tracking-tight">Friend Music Management</h1>
              <span className="px-2 py-0.5 bg-indigo-100 text-indigo-700 text-[10px] font-black rounded-md">ADMIN</span>
            </div>
            <p className="text-xs text-emerald-600 font-bold mt-1">● Quản lý trung tâm & Toàn quyền hệ thống</p>
          </div>
          <div className="flex items-center gap-2">
